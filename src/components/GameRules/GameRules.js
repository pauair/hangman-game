    ...
    return (
        <div className="div-rules z-10 py-6 lg:px-6 text-white border rounded-2xl content-center">
            <>
                ...
                <p className='div-rules-p px-10 lg:px-12 pb-2 text-left'>Generate a random word to guess, represented by underscores indicating the number of letters.</p>
                ...
                <p className='div-rules-p px-10 lg:px-12 pb-2 text-left'>Correctly guessing a letter <strong className='div-rules-p text-green-500'>earns you 6 points</strong>, while an incorrect guess <strong className='div-rules-p text-red-600'> deducts 2 points</strong> for an incorrect letter.</p>
